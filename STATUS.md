...
| 22.1 — Tooling: CI, Dependabot, madge/knip, stats.js | [`fase22.1-spec.md`](docs/spec/fase22.1-spec.md) | ✅ **Cerrada (2026-08-22)** — CI Actions bloqueante, Dependabot semanal, madge/knip informativos, stats.js + GPUStatsPanel+F3, addons three (BufferGeometryUtils, tween, Line2) vendorizados e integrados; suite **64/64**, `node --check` limpio |
...
| 22.3 — Correcciones y paridad diferidas (borrador; era la antigua 22.1) | [`fase22.3-spec.md`](docs/spec/fase22.3-spec.md) | F21.6 cerrada ✅ |
