...
| 20 — Rolling release (ciclo de estabilización y paridad) | [`fase20-spec.md`](spec/fase20-spec.md) · iteraciones [`v20.1.md`](v20.1.md) · v20.2 (spec B7) | Prospectiva (notas + borrador + entrevista) | 🟠 **En curso (v20.1 cerrada, v20.2 definida y en cierre)** | Prerrequisito: F18 cerrada (y F16/F17). Ciclo de iteraciones v20.x con auditoría por iteración obligatoria. **v20.1 cerrada (2026-08-16):** TNT **knockback**, **fundido explícito de mena** (RAW_IRON 258/RAW_GOLD 259 → lingote), rendimiento del backlog 2026-08-15 (**P4 generación determinista**, **P7 índice espacial de antorchas**, P1/P3/CL-6 verificados, P2 rechazado con métrica); unit 59/59 + E2E 7/7 + `--audit` 6/6 + biome 0. **v20.2 (2026-08-16, spec B7):** bugs de las notas **D1** `#menu-bg` (`875f8e1`) y **D2** desconexión al cargar el mundo (`18bbc2e`, causa real del F19.6 B2 — rate-limit por procesamiento, fix `server/ratelimit.js`) + backlog B6 implementado (SV-5 `MAX_STACK` 64, REN-1 `savePlayersAsync`, CI 19 timeouts CDP, CI 20 `npm run audit`); unit 60/60. Documento de la iteración: [`v20.1.md`](v20.1.md) |
