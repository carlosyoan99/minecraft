...
> de crafteo, hornos y demás interfases\"), del borrador `docs/fase19-spec.md`
...
- Fuentes: `docs/Notas del usuario.md`, borrador `docs/fase19-spec.md`,
  `docs/fase18-spec.md` (estado y decisiones diferidas), `CLAUDE.md`/
...
- **Ficheros:** `public/ui.js` (drop handlers de `#chest-ui`/`#furnace-ui`),
  ...
  handler necesita destino), `tests/unit-red.js`/`unit-fase19.js`.
